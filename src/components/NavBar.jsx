...
export default function NavBar() {
  return (
    <div>
      <nav class="flex items-center justify-between flex-wrap bg-midnight-blue p-6">
        <div class="flex items-center flex-shrink-0 text-white mr-6">
          <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 40 32" class="fill-slate-300">
          ...
          <span class="font-semibold text-xl text-slate-300 tracking-tight">Spaceship Database App</span>
        </div>
      </nav>
    </div>
  )
